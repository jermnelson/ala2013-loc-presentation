...
<div class="row-fluid marketing">
 ...
 <button type="button" class="close" data-dismiss="alert">&times;</button>
  ...
  <p class="lead">
   ...
   minimal viable product to demonstrate the possibilities of a 
   LinkedData-based bibliographic datastore running on Redis.
  </p>
 </div>
</div>
<div class="row-fluid marketing">
...
<a href="/glossary.html#kuoli">Kuali</a> interoperability.
...
<div class="row-fluid marketing">
 ...
 <p class="lead">
  I want to thank the Library of Congress for their leadership and great work 
  being done for the library and linked data communities. Bibframe is a 
