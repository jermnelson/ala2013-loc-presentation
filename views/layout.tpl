...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>BIBFRAME in the Redis Library Service Platform</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" 
          content="A website for Jeremy Nelson's presentation at the Library 
          of Congress BIBFRAME session at ALA 2013 in Chicago, IL">
    <meta name="author" content="Jeremy Nelson">

    <!-- Le styles -->
    <link href="/ala2013/assets/css/bootstrap.css" rel="stylesheet">
    <style type="text/css">
      body {
        padding-top: 20px;
        padding-bottom: 40px;
    ...
    <link href="/ala2013/assets/css/bootstrap-responsive.css" rel="stylesheet">
    ...
    <!--[if lt IE 9]>
      <script src="/ala2013/assets/js/html5shiv.js"></script>
    <![endif]-->
